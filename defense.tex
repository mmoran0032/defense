...
\begin{frame}[fragile]{Angular and Energy Acceptance}
    ...
    \[
        ...
        \quad\quad\quad
        \begin{split}
            \theta_{\rm recoil} = \atan\left(\frac{p_{\gamma}}{\sqrt{2m_AE_A}}\right)
        \end{split}
    \]
...
\begin{frame}[fragile]{Importance of Acceptances}
    ...
    possibilities, separator has a single tune that is scaled to new values
...
\begin{frame}[fragile]{Angular Acceptance Measurement}
    ...
    \begin{itemize}
        ...
        \item still supports ongoing work to prepare the separator for future experiments
    \end{itemize}
...
% describe how you actually break everything apart

\begin{frame}
    \begin{figure}
        \includegraphics[width=0.85\textwidth]{figures/inputs.png}
    \end{figure}
\end{frame}
